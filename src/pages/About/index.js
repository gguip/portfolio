...
const techItem = ["Node.js", "ReactJS", "React Native", "Express.js", "Redux", "Hooks", "MongoDB", "PostgreSQL", "Saga", "MySQL", "Styled Components", "ElectronJS", "Typescript", "Next.JS"];
...
export default function About() {
  return (
    <Layout center id="about">
      ...
      <Container>
        <Paragraph>
        I'm 30 years old, I live in Brazil, in Tatuí, a town in the
          ...
          2018, when I worked in a IT company and I loved it. I really like the
